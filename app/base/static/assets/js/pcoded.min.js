...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://www.multilab.co/index.php?lang=es" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> Acerca de Multilab' +
    '</a> ' + '</div>' + '');
var $window = $(window);
